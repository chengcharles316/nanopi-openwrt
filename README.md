...
slim版
```bash
wget -qO- https://github.com/biliwala/nanopi-openwrt/raw/main/scripts/autoupdate.sh | ver=-slim sh
```
(脚本由gary lau提供，非常感谢！)
...
#### 本固件NAT基准性能测试：
<img src="https://raw.githubusercontent.com/biliwala/nanopi-openwrt/main/assets/NAT.jpg" width="450" />
